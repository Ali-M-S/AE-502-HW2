...
RA0 = 0*deg; %Right ascencion of the node (radians)
i0 = acos(sqrt(1/5)); %Inclination (radians)
w0 = -90*deg; %Argument of perigee (radians)
e0 = 0.655996546922959; %eccentricity
a0 = 20261.4245225005; %Semimajor axis (km)
TA0 = 0;
...
% Plotting Trajectory
plot3(x,y,z,'color',"#00FF00",'LineWidth',1)
hold off

%...Plot the time histories of the osculatinig elements:
figure(2)
subplot(2,1,1)
plot(t/days,(RA)/deg,'color',"#77AC30",'LineWidth',1)
...
axis tight
subplot(2,1,2)
plot(t/days,(w)/deg,'color',"#77AC30",'LineWidth',1)
...
figure(3)
subplot(3,1,1)
plot(t/days,h,'color',"#77AC30",'LineWidth',1)
...
axis tight
subplot(3,1,2)
plot(t/days,e,'color',"#77AC30",'LineWidth',1)
title('Eccentricity')
xlabel('days')
grid on
grid minor
axis tight
subplot(3,1,3)
plot(t/days,(i)/deg,'color',"#77AC30",'LineWidth',1)
...
figure(4)
subplot(3,1,1)
plot(t/days,a,'color',"#77AC30",'LineWidth',1)
...
axis tight
subplot(3,1,2)
plot(t/days,rp,'color',"#77AC30",'LineWidth',1)
...
axis tight
subplot(3,1,3)
plot(t/days,TA/deg,'color',"#77AC30",'LineWidth',1)
